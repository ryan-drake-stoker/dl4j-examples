 ...
 * @author Alex Black
 */
public class Word2VecCategorisationRNN {

    /** Data URL for downloading */
    public static final String DATA_URL = "http://ai.stanford.edu/~amaas/data/sentiment/aclImdb_v1.tar.gz";
    /** Location to save and extract the training/testing data */
    public static final String DATA_PATH = "/home/ryan/projects/dl_service/alt_fund_royalties";
    ...
    public static void main(String[] args) throws Exception {
        ...
        VariableRatioSentimentExampleIterator train = new VariableRatioSentimentExampleIterator(DATA_PATH, wordVectors, batchSize, truncateReviewsToLength, true, 15);
        VariableRatioSentimentExampleIterator test = new VariableRatioSentimentExampleIterator(DATA_PATH, wordVectors, batchSize, truncateReviewsToLength, false, 15);
